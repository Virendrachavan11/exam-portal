...
export const SvAccountCreationMail = async (EmailId, nameofsv, Password) => {
    const subject = "Your Phoenix Exam Portal Account Details";
    const text = "Your supervisor account has been created. Please see below for login credentials.";

    const html = `
        <div style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
            <h2 style="color: #4A90E2;">Phoenix Exam Portal</h2>
            <p>Hi <strong>${nameofsv}</strong>,</p>
            <p>Welcome aboard! Your supervisor account has been successfully created by us.</p>
            ...
            <p>👉 Please log in and <strong>change your password immediately</strong> to ensure account security.</p>

            <p style="margin-top: 30px;">Regards,<br/>Phoenix Exam Portal Team</p>
        </div>
    `;
